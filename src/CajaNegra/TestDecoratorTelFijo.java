...
public class TestDecoratorTelFijo {
	...
	public void setUp() throws Exception {
		...
		//ya que tenemos 2 escenarios diferentes, pero bueno lo unifiqué todo en una clase.
	}
	...
	public void testGetFacturaInternet100() {
		//Estas 2 lineas serían el setUp del escenario 1.
		...
		Assert.assertEquals("El string de factura recibido no es el esperado.", cadena, d.getFactura());
	}
	
	@Test
	public void testGetFacturaInternet500() {
		//estas 2 lineas serían el setUp del escenario 2.
	...
	public void testGetCostoInternet100() {
		...
		Assert.assertEquals("El costo recibido no es el correcto.", costo, d.getCosto());
	}
