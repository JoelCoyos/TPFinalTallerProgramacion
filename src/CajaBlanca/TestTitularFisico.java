...
public class TestTitularFisico {
	...
	public void testGetCostoFinalEfectivo() {
		...
		double costoFinal = 850 - 850*0.20;
		
		Assert.assertEquals("El costo final obtenido no es correcto", costoFinal, this.t.getCostoFinal());
	}
	...
	public void testGetCostoFinalCheque() {
		...
		double costoFinal = 850 + 850*0.10;
